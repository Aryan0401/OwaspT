...
export default function PrizeCharacter3D({ character = 'thanos' }) {
      ...
      >
        ...
        {character === 'thanos' && (
          <>
            ...
            <Sparkles count={45} scale={[3.8, 3.8, 2]} size={2.5} speed={0.4} color="#ffd700" opacity={0.7} />
          </>
        )}
        ...
        {character === 'gamora' && (
          <>
            ...
            <Sparkles count={40} scale={[3.8, 3.8, 2]} size={2.2} speed={0.4} color="#34d399" opacity={0.7} />
          </>
        )}
        ...
        {character === 'redskull' && (
          <>
            ...
            <Sparkles count={45} scale={[3.8, 3.8, 2]} size={2.4} speed={0.4} color="#ef4444" opacity={0.7} />
          </>
        )}
      </Canvas>
    </div>
